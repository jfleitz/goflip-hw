...
WORKDIR = X:\ePin\source\LampDriver
...
OUTDIR = X:\ePin\source\LampDriver
...
clean: 
	...
	@if exist $(WORKDIR)\i2cslave.map  \
            $(RM) $(WORKDIR)\i2cslave.map
	@if exist $(WORKDIR)\sda_interrup.obj  \
            $(RM) $(WORKDIR)\sda_interrup.obj
...
$(WORKDIR)\sda_interrup.obj :  \
            X:\ePin\source\LampDriver\sda_interrup.c  \
            ...
            $(INCLUDE)\zilog\ez8.h  \
            X:\ePin\source\LampDriver\scl_interrupt.h
	 $(CC) $(CFLAGS) X:\ePin\source\LampDriver\sda_interrup.c

$(WORKDIR)\zsldevinit.obj :  \
            X:\ePin\source\LampDriver\zsldevinit.asm  \
            $(INCLUDE)\zilog\ez8dev.inc  \
            $(INCLUDE)\zilog\gpio.inc
	 $(AS) $(ASFLAGS) X:\ePin\source\LampDriver\zsldevinit.asm

$(WORKDIR)\lampDriver.obj :  \
            X:\ePin\source\LampDriver\lampDriver.c  \
            ...
            $(INCLUDE)\zilog\Zconst.h  \
            $(INCLUDE)\zilog\ez8.h  \
            X:\ePin\source\LampDriver\include\lampDriver.h  \
            X:\ePin\source\LampDriver\include\sysclk.h  \
            X:\ePin\source\LampDriver\include\timer.h
	 $(CC) $(CFLAGS) X:\ePin\source\LampDriver\lampDriver.c

$(WORKDIR)\sysclk.obj :  \
            X:\ePin\source\LampDriver\sysclk.c  \
            $(INCLUDE)\zilog\defines.h  \
            $(INCLUDE)\zilog\dmadefs.h  \
            $(INCLUDE)\zilog\gpio.h  \
            $(INCLUDE)\zilog\uart.h  \
            ...
            X:\ePin\source\LampDriver\include\lampDriver.h  \
            X:\ePin\source\LampDriver\include\sysclk.h
	 $(CC) $(CFLAGS) X:\ePin\source\LampDriver\sysclk.c

$(WORKDIR)\timer.obj :  \
            X:\ePin\source\LampDriver\timer.c  \
            $(INCLUDE)\std\STDARG.H  \
            $(INCLUDE)\zilog\Zconst.h  \
            $(INCLUDE)\zilog\defines.h  \
            $(INCLUDE)\zilog\dmadefs.h  \
            ...
            X:\ePin\source\LampDriver\include\lampDriver.h  \
            X:\ePin\source\LampDriver\include\timer.h
	 $(CC) $(CFLAGS) X:\ePin\source\LampDriver\timer.c
