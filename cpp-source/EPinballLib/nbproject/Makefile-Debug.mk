...
${OBJECTDIR}/BasePart.o: BasePart.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasePart.o BasePart.cpp

${OBJECTDIR}/MachineControl.o: MachineControl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MachineControl.o MachineControl.cpp

${OBJECTDIR}/MessageBase.o: MessageBase.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageBase.o MessageBase.cpp

${OBJECTDIR}/PeripheralThread.o: PeripheralThread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeripheralThread.o PeripheralThread.cpp

${OBJECTDIR}/PopBumper.o: PopBumper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PopBumper.o PopBumper.cpp

${OBJECTDIR}/TimedMode.o: TimedMode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TimedMode.o TimedMode.cpp

${OBJECTDIR}/UntimedMode.o: UntimedMode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UntimedMode.o UntimedMode.cpp
